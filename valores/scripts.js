...
const cardOptions = document.querySelectorAll(".contenedor-valores .cardvalor .cardvalor__optionvalor");
// target all dd elements
const cardOptionsDescriptions = document.querySelectorAll(".contenedor-valores .cardvalor .cardvalor__optionvalor dl dd");
// target all span elements
const cardOptionsSpans = document.querySelectorAll(".contenedor-valores .cardvalor .cardvalor__optionvalor span");
...
function displayOption(targetClick) {
    ...
    while(!target.classList.contains("cardvalor__optionvalor")) {
    ...
    // additionally reset the background of the parent contenedor-valores and add the plus sign + back
    ...
    // additionally, style the parent contenedor-valores by changing its background and remove the plus sign from the nested span
    else {
        removeOptions();
...
// additionally reset the background of the parent contenedor-valores and restore the plus sign + on all span elements
